    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (await _userStore.ValidateCredentials(model.Username, model.Password))
                {
                    ...
                    await HttpContext.Authentication.SignInAsync(user.SubjectId.ToString(), 
                        user.UserName, props);
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            if (user == null)
            {
                ...
                user = await _userStore.AutoProvisionUser(provider, userId, claims);
            }
            ...
            await HttpContext.Authentication.SignInAsync(user.SubjectId.ToString(), 
                user.UserName, provider, additionalClaims.ToArray());
